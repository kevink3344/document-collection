...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        CollectionField: {
          ...
          properties: {
            id:           { type: 'integer', example: 1 },
            type:         { type: 'string',  enum: ['short_text', 'date', 'long_text', 'single_choice', 'multiple_choice', 'attachment', 'signature', 'confirmation', 'custom_table', 'rating', 'comment', 'matrix_likert_scale'] },
        ...
        Notification: {
          type: 'object',
          properties: {
            id:             { type: 'integer', example: 12, description: 'In-app delivery ID' },
            deliveryId:     { type: 'integer', example: 12 },
            eventId:        { type: 'integer', example: 7 },
            userId:         { type: 'integer', example: 3, nullable: true },
            collectionId:   { type: 'integer', example: 5, nullable: true },
            collectionSlug: { type: 'string',  example: 'quarterly-survey-abc123', nullable: true },
            type:           { type: 'string',  enum: ['due_soon', 'overdue', 'system'] },
            title:          { type: 'string',  example: 'Collection overdue' },
            message:        { type: 'string',  example: '"Quarterly Survey" was due on 2026-05-01.' },
            dueDate:        { type: 'string',  example: '2026-05-01', nullable: true },
            isRead:         { type: 'boolean', example: false },
            createdAt:      { type: 'string',  format: 'date-time' },
            readAt:         { type: 'string',  format: 'date-time', nullable: true },
            actionUrl:      { type: 'string',  nullable: true, example: '/fill/quarterly-survey-abc123' },
            channel:        { type: 'string',  enum: ['in_app', 'email'] },
            recipientRole:  { type: 'string',  enum: ['primary', 'cc'] },
          },
        },
        NotificationPreferences: {
          ...
          properties: {
            ...
            dueSoon:            { type: 'boolean', example: true },
            overdue:            { type: 'boolean', example: true },
            collectionUpdates:  { type: 'boolean', example: true },
            submissionActivity: { type: 'boolean', example: true },
            adminEvents:        { type: 'boolean', example: true },
          },
        },
        NotificationEmailCc: {
          type: 'object',
          properties: {
            ...
            notificationTypes: {
              type: 'array',
              nullable: true,
              items: { type: 'string', enum: ['due_soon', 'overdue', 'system'] },
            },
    ...
    tags: [
      ...
      { name: 'Notifications', description: 'In-app and email-backed notifications with CC support' },
    ],
  },
  apis: SWAGGER_APIS,
}
